...
def start_system():
    ...
    try:
        ...
        print("      [OK] API Server started (PID: {})".format(api_process.pid))
        ...
        print("      [OK] Agent started (PID: {})".format(agent_process.pid))
        
        print()
        print("=" * 70)
        print("  [OK] EventEngine System Running")
        print("=" * 70)
        print()
        print("  [+] Frontend URL:")
        ...
        while True:
            ...
            if agent_process.poll() is not None:
                print("  [!] Agent stopped unexpectedly!")
                if api_process:
                    api_process.terminate()
                sys.exit(1)
